...
namespace ProductReviewAPI
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Administrator\Downloads\ProductReviewTraining2.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Summary",outputColumnName:@"Summary")      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Summary"}))      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=3943,MinimumExampleCountPerLeaf=34,LearningRate=0.605085864136421,LabelColumnName=@"Sentiment",FeatureColumnName=@"Features",ExampleWeightColumnName=null,Booster=new GradientBooster.Options(){SubsampleFraction=0.537456729309243,FeatureFraction=0.893013480992893,L1Regularization=6.40096164468556E-10,L2Regularization=0.140059930345658},MaximumBinCountPerFeature=319}))      
